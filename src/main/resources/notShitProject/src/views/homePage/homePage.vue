...
let backgroundImage = ref('@/assets/background.png');
...
function changeTab(tabName) {
  switch (tabName) {
    case 'dayRead':
      ...
      backgroundImage.value = '@/assets/background-dayRead.png';
      break
    case 'other':
      that.$message.info('正在建设中！')
      break
    case 'other':
      that.$message.info('dayRead');
      backgroundImage.value = '@/assets/background-other.png';
      break;
    default:
      break
  }
